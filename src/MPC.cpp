...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs)
{
    ...
    size_t n_vars = N * kStateVectorSize + (N - 1) * 2;
    ...
    size_t n_constraints = N * kStateVectorSize;
    std::cout << "Number of constraints: " << n_constraints << endl;
    ...
    std::cout << "Creating  objective and constraints ..." << endl;
    ...
    // solve the problem
    std::cout << "Solving the actual problem ..." << endl;
    ...
    CppAD::ipopt::solve<Dvector, FG_eval>(options,
                                          ...
                                          fg_eval,
                                          solution);
    std::cout << "Solving successful ..." << endl;
